	      ...
	      <div class="tab-content">
	        <div class="tab-pane active" id="general">
	         				...
	         				<div class="span12">
	         					<div class="span3" style="margin-left: 0px;">
		         					...
		         					<div class="input-append">
									  {{ Form::text('published_on','',array('placeholder' => 'Yayınlanma Tarihi',  'id' => 'article_published_on' , 'class' => 'span2', 'autocomplete' => 'off')) }}
								...
								<div class="span4">
									...
									<div class="input-append">
									  {{ Form::text('published_off','',array('placeholder' => 'Yayından Çekme Tarihi',  'id' => 'article_published_off' , 'class' => 'span2', 'autocomplete' => 'off')) }}
									  <span class="add-on"><i class="icon-list-alt"></i></span>
					...
					<div class="control-group">
				        ...
				        <div class="controls">
				         	{{ Form::text('title','',array('placeholder' => 'Makale Başlık', 'required' => '' , 'class' => 'span4')) }}
				        </div>
				    </div>
