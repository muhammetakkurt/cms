...
if(! defined('ERROR_IMAGE') )			define ('ERROR_IMAGE', 'no_image.png');									// Image to serve if an error occurs instead of showing error message 
...
class timthumb {
	...
	protected function serveImg($file){
		ob_start();
		header("Location: thumbnail.php?src=".$file."&w=".$_GET['w']."&h=".$_GET['h']);
		ob_end();
		/*
		$s = getimagesize($file);
		if(! ($s && $s['mime'])){
